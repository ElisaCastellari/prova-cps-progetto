...
//button handling
//extern volatile uint8_t buttonPressed = 0; // 0 if not pressed 1 if pressed
/* USER CODE END ET */
...
//gpio handling
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin); //callback to handle button pressed

//timer handling
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim); //handling timer period elapsed
/* USER CODE END EFP */
...
#define BUTTON_0_EXTI_IRQn EXTI3_IRQn
